...
def resize_images(input_dir, output_dir, max_size=1024):
    ...
    参数: input_dir (str): 输入图像目录 output_dir (str): 输出图像目录 max_size (int): 最大边的像素数
    """
    # 确保输出目录存在
...
def adjust_yolo_labels(input_label_dir, output_label_dir, original_size, new_size):
    ...
    参数: input_label_dir (str): 输入标签目录 output_label_dir (str): 输出标签目录 original_size (tuple): 原始图像尺寸 (width, height)
...
def process_dataset(input_image_dir, input_label_dir, output_image_dir, output_label_dir, max_size=1024):
    ...
    参数: input_image_dir (str): 输入图像目录 input_label_dir (str): 输入标签目录 output_image_dir (str): 输出图像目录 output_label_dir
    (str): 输出标签目录 max_size (int): 最大边的像素数
    """
    # 确保输出目录存在
...
if __name__ == "__main__":
    ...
    path = "/root/autodl-tmp/ultralytics-main/data/Black_png/"
    new_path = "/root/autodl-tmp/ultralytics-main/data/Black_png"
