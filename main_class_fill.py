...
def run_classification_prediction(
    checkpoint, data, defect_class, predict_dir_name="predict_v3", confidence_threshold=0.0
):
    """封装分类任务的预测代码."""
    print("--- 运行分类预测 ---")
    model = YOLO(checkpoint)
...
def main():
    ## 分类
    # 设置要操作的根目录
    data = r"/root/autodl-tmp/ultralytics-main/data/WX_class/v6/v6.3-multi_split"
